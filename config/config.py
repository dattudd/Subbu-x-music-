...
LOG_GROUP_ID = int(getenv("LOG_GROUP_ID", "-1002055640243"))

# A name for your Music bot.
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "sus x music")

# Your User ID.
OWNER_ID = list(
    map(int, getenv("OWNER_ID", "6439286014").split())
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/dattudd/Subbu-x-music-",
)
